  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-between">
        ...
        <div className='flex flex-col bg-secondary text-primary p-5 w-full'>
            <h1 className="text-4xl uppercase tracking-[0.25em] font-montserrat px-5 pt-10 text-center font-black opacity-70">Interest Form</h1>
            <form className="flex flex-col gap-4 mt-8 md:flex-row md:flex-wrap">
                ...
                <select id="skinConcern" name="skinConcern" className="border rounded p-2 mt-1" value={formFields.skinConcern} onChange={(event) => {setFormFields((prevState) => ({...prevState, skinConcern: event.target.value}))}}>
                ...
                <select id="hairConcern" name="hairConcern" className="border rounded p-2 mt-1" value={formFields.hairConcern} onChange={(event) => {setFormFields((prevState) => ({...prevState, hairConcern: event.target.value}))}}>
                    <option value="dryness">Dryness</option>
                ...
                <select id="productInterest" name="productInterest" className="border rounded p-2 mt-1" value={formFields.productInterest} onChange={(event) => {setFormFields((prevState) => ({...prevState, productInterest: event.target.value}))}}>
                ...
                <select id="tryFrequency" name="tryFrequency" className="border rounded p-2 mt-1" value={formFields.tryFrequency} onChange={(event) => {setFormFields((prevState) => ({...prevState, tryFrequency: event.target.value}))}}>
                ...
                <select id="importantFactors" name="importantFactors" className="border rounded p-2 mt-1" value={formFields.importantFactors} onChange={(event) => {setFormFields((prevState) => ({...prevState, importantFactors: event.target.value}))}}>
                ...
                <div className="flex flex-col md:basis-1">
                ...
                <button type="submit" className="mt-4 py-2 px-4 bg-primary text-secondary rounded" onClick={() => submitForm()}>Submit</button>
            </form>
        </div>
